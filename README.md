...
Этот проект предоставляет пример потока Node-RED для интеграции с сервисом DaData. Интеграция позволяет получать актуальные данные о банках, компаниях и ИП, а также автоматически заполнять данные для формирования договоров и других документов.
...
---
## Как использовать
1. Скачайте файл [dadataflows.json](https://github.com/DaData-Node-Red/blob/main/dadataflow.json) из этого репозитория.
